...
<body>
  ...
  <p>
    <strong>This is a feed of articles on this website. </strong> Subscribe by copying the URL from the address bar into your newsreader.
  </p>
  <p>
  ...
  <article class="entry">
    <h3><a>
      ...
      <xsl:value-of select="title|atom:title"/></a></h3>
    <h4><xsl:value-of select="description|atom:summary"/></h4>
    <p class="posted">Posted at <xsl:value-of select="pubDate|atom:published" /></p>
  </article>
  </xsl:for-each>
  </main>
  <footer>Last updated  <xsl:value-of select="/rss/channel/lastBuildDate|/atom:feed/atom:updated" /> </footer>
</body>
